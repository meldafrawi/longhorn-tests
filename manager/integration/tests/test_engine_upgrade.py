...
def test_engine_image(client, core_api, volume_name):  # NOQA
    ...
    assert images.data[0].gitCommit != ""
    assert images.data[0].buildDate != ""
...
def test_engine_image_incompatible(client, core_api, volume_name):  # NOQA
    ...
    cli_v = images.data[0].cliAPIVersion
    # cli_minv = images[0].cliAPIMinVersion
    ctl_v = images.data[0].controllerAPIVersion
    ctl_minv = images.data[0].controllerAPIMinVersion
    data_v = images.data[0].dataFormatVersion
    data_minv = images.data[0].dataFormatMinVersion
